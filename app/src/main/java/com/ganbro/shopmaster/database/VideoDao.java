...
public class VideoDao {
    ...
    public void addVideo(Video video) {
        ...
        values.put(DatabaseManager.COLUMN_COMMENTS_COUNT, video.getCommentsCount());
        ...
        if (cursor.moveToFirst()) {
            do {
                Video video = new Video(
                        ...
                        cursor.getInt(cursor.getColumnIndexOrThrow(DatabaseManager.COLUMN_COMMENTS_COUNT)),
    ...
    public void initializeVideos() {
        addVideo(new Video(0, "android.resource://com.ganbro.shopmaster/raw/sample_video", "描述1", 0, 0, 0));
    }
}
